--[[
CREDITS TO ALORA FOR MAIN CODE
...
local ver = "1.0.1"
--files
if not isfolder("Neverblox") then
 makefolder("Neverblox")
end
if not isfolder("Neverblox/"..tostring(game.GameId)) then
...
local NeverbloxWatermark = Drawing.new("Text");NeverbloxWatermark.Font = Drawing.Fonts.Plex;NeverbloxWatermark.Position = Vector2.new(50,24);NeverbloxWatermark.Visible = false;NeverbloxWatermark.Size = 16;NeverbloxWatermark.Color = Color3.new(1,1,1);NeverbloxWatermark.Outline = true
...
drawingGroup:addToggle({text = "Unit Graph",flag = "velo_graph"})
drawingGroup:addToggle({text = "Unit Indicator",flag = "velo_indicator"})
drawingGroup:addToggle({text = "Movement Indicator",flag = "wasd_indicator"})
...
movementGroup:addToggle({text = "AutoBHOP (Blatant)",flag = "bunny_hop",callback = function()
...
otherGroup2:addToggle({text = "Watermark",flag = "watermark_enabled",callback = function(val)
 NeverbloxWatermark.Visible = val
end})
...
otherGroup2:addList({text = "HitSound",flag = "hitsound_value",values = {"Bameware","Bell","Bubble","Pick","Pop","Rust","Skeet","Neverlose","Minecraft"}})
otherGroup2:addButton({text = "Give Skins",callback = function() 
...
function onStep()
 ...
 if library.flags["watermark_enabled"] then
     ...
     NeverbloxWatermark.Text = "Neverblox | "..ver.." | "..hours..":"..minutes..":"..seconds
 end
end
